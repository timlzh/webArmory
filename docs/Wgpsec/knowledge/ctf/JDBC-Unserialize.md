...
![demo](/assets/wgpsec/images/jdbc/demo.gif)
...
![1639912376869](/assets/wgpsec/images/jdbc/1639912376869.png)
...
![1639912652758](/assets/wgpsec/images/jdbc/1639912652758.png)

![1639913370875](/assets/wgpsec/images/jdbc/1639913370875.png)
...
![1639912991843](/assets/wgpsec/images/jdbc/1639912991843.png)

![1639913305959](/assets/wgpsec/images/jdbc/1639913305959.png)

 此处columnIndex为2处才能走到反序列化的代码逻辑，为1则直接返回null。 

![1639913333697](/assets/wgpsec/images/jdbc/1639913333697.png)

在`mysql-connector-java-8.0.19.jar/com/mysql/cj/jdbc/result/ResultSetImpl.class:1079`可以很明显的看到。

![1639913734078](/assets/wgpsec/images/jdbc/1639913734078.png)

判断MySQL类型为BLOB后，从MySQL服务端中获取对应的字节码数据、判断autoDeserialize是否为true、字节码数据是否为序列化对象等条件后调用`readObject()`触发反序列化漏洞。

![demo1](/assets/wgpsec/images/jdbc/demo1.gif)
...
![1639920417039](/assets/wgpsec/images/jdbc/1639920417039.png)
...
![demo2](/assets/wgpsec/images/jdbc/demo2.gif)
